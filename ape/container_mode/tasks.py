...
def export_config_to_equation(poi=None):
    ...
    try:
        generator.generate_equation(container_dir, product_name)
        print('*** Successfully generated the product equation')
    except exceptions.EquationGeneratorException as e:
        raise
        return
